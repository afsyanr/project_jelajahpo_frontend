                    ...
                    {wisata.length > 0 ? (
                        wisata.map((item) => (
                            <tr key={item.id_wisata}>
                                ...
                                <td>
                                    <button type="button" className="btn btn-warning btn-sm me-2" onClick={() => handleEdit(item.id_wisata)}>
                                        Edit
                                    </button>
                                </td>
                                <td>
                                    <button type="button" className="btn btn-danger btn-sm" onClick={() => handleDelete(item.id_wisata)}>
                                        Delete
                                    </button>
                                </td>
                            </tr>
